...
public:
 ...
 private:
  ...
  //std::vector<l1t::EGammaRef> l1IsoObjectsToken_;
  edm::EDGetTokenT<BXVector<l1t::EGamma> > l1IsoObjectsToken_;
  float minET_;
  float dRMatch_;
};
...
MiniAODL1CandProducerV3<T>::MiniAODL1CandProducerV3(const edm::ParameterSet& iConfig ) :
  ...
  l1IsoObjectsToken_(consumes<BXVector<l1t::EGamma>>(iConfig.getParameter<edm::InputTag>("isoObjects"))),
...
void MiniAODL1CandProducerV3<T>::produce(edm::Event &iEvent, const edm::EventSetup &eventSetup) {
  ...
  iEvent.getByToken(l1IsoObjectsToken_, l1Cands);
