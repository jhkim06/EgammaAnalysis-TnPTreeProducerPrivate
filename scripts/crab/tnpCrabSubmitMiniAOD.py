...
mainOutputDir = '/store/user/jhkim/%s' % submitVersion
...
config.JobType.psetName  = '/afs/cern.ch/work/j/jhkim/EGM_SFs/CMSSW_10_2_5/src/EgammaAnalysis/TnPTreeProducer/python/TnPTreeProducer_cfg.py'
...
#    config.Data.inputDataset    = '/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISpring18MiniAOD-100X_upgrade2018_realistic_v10-v2/MINIAODSIM'
    ...
    config.JobType.pyCfgParams  = ['isMC=True',doEleTree,doPhoTree, doHLTTree, 'GT=100X_upgrade2018_realistic_v10']
...
#    config.JobType.pyCfgParams  = ['isMC=False',doEleTree,doPhoTree, doHLTTree, 'GT=101X_dataRun2_Prompt_v9']
# 
...
#    submit(config)
#
#    config.General.requestName  = 'Prompt2018_RunE_v1'
#    config.Data.inputDataset    = '/EGamma/Run2018E-PromptReco-v1/MINIAOD'
#    submit(config)
