...
process.probeElePassPMS2SeededFilterDouble33 = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.1),
...
process.probeElePassPMS2UnseededFilterDouble33 = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.1),
...
process.hlt_sequence = cms.Sequence(process.probeElePassL1T+process.probeElePassEtLeg1+process.probeElePassClusterShapeLeg1+process.probeElePassHELeg1+process.probeElePassEcalIsoLeg1+process.probeElePassHcalIsoLeg1+process.probeElePassPixelMatchLeg1+process.probeElePassOneOEMinusOneOPLeg1+process.probeElePassDetaLeg1+process.probeElePassDphiLeg1+process.probeElePassTrackIsoLeg1+process.probeElePassEtLeg2+process.probeElePassClusterShapeLeg2+process.probeElePassHELeg2+process.probeElePassEcalIsoLeg2+process.probeElePassHcalIsoLeg2+process.probeElePassPixelMatchLeg2+process.probeElePassOneOEMinusOneOPLeg2+process.probeElePassDetaLeg2+process.probeElePassDphiLeg2+process.probeElePassTrackIsoLeg2+process.probeElePassPMS2SeededFilterDouble33+process.probeElePassPMS2UnseededFilterDouble33)
