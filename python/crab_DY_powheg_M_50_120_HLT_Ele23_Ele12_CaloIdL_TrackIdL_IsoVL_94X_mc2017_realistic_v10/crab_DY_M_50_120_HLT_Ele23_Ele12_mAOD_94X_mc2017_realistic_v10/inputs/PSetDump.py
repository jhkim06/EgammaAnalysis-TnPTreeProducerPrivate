...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/RunIIFall17MiniAOD/ZToEE_NNPDF31_13TeV-powheg_M_50_120/MINIAODSIM/94X_mc2017_realistic_v10-v2/20000/06E355FC-F70F-E811-9951-0CC47A706FF8.root')
)
...
process.hltFilter = cms.EDFilter("HLTHighLevel",
    HLTPaths = cms.vstring('HLT_Ele35_WPTight_Gsf_v7'),
...
process.pho_sequence = cms.Sequence(process.goodPhotons+process.egmPhotonIDSequence+process.probePhoCutBasedLoose+process.probePhoCutBasedMedium+process.probePhoCutBasedTight+process.probePhoMVA+process.probePho+process.genProbePho)


process.egmGsfElectronIDSequence = cms.Sequence(process.egmGsfElectronIDTask)


process.tag_sequence = cms.Sequence(process.goodElectrons+process.egmGsfElectronIDSequence+process.tagEleCutBasedTight+process.tagEle+process.genEle+process.genTagEle)
