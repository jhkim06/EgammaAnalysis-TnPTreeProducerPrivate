# hltGetConfiguration orcoff:/cdaq/physics/Run2017/2e34/v3.0.0/HLT/V1 --process HLTX --globaltag 94X_mc2017_realistic_v10 --path HLTriggerFirstPath,HLTriggerFinalPath,HLT_DoubleEle33_CaloIdL_MW_v15 --offline --unprescale
...
process.HLT_DoubleEle33_CaloIdL_MW_v15 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau + process.hltPreDoubleEle33CaloIdLMW + process.HLTEle33CaloIdLMWSequence + process.HLTDoubleEle33CaloIdLMWSequence + process.HLTEndSequence )
