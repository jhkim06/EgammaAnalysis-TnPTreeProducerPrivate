...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/data/Run2017D/SingleElectron/MINIAOD/17Nov2017-v1/40000/0A298754-26DC-E711-AC2D-0CC47AF9B1B2.root')
)
...
process.probeElePassGsfTrackIsoEle32WPTight = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.1),
...
process.probeElePassHcalIsoEle32WPTight = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.1),
    filterNames = cms.vstring('hltEle32WPTightHcalIsoFilter'),
    inputs = cms.InputTag("probeEle"),
    isAND = cms.bool(False),
    objects = cms.InputTag("slimmedPatTrigger")
)
...
process.probeElePassL1TEle32WPTight = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.1),
...
process.probeElePassL1TEtEle32WPTight = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.1),
    filterNames = cms.vstring('hltEG32L1SingleEGOrEtFilter'),
    inputs = cms.InputTag("probeEle"),
    isAND = cms.bool(False),
    objects = cms.InputTag("slimmedPatTrigger")
)
...
process.probeElePassPMS2Ele32WPTight = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.1),
    filterNames = cms.vstring('hltEle32WPTightPMS2Filter'),
    inputs = cms.InputTag("probeEle"),
    isAND = cms.bool(False),
    objects = cms.InputTag("slimmedPatTrigger")
)
...
process.probeElePassPixelMatchEle32WPTight = cms.EDProducer("PatElectronTriggerCandProducer",
    bits = cms.InputTag("TriggerResults","","HLT"),
    dR = cms.double(0.1),
    filterNames = cms.vstring('hltEle32WPTightPixelMatchFilter'),
    inputs = cms.InputTag("probeEle"),
    isAND = cms.bool(False),
    objects = cms.InputTag("slimmedPatTrigger")
)
...
process.tnpEleTrig = cms.EDAnalyzer("TagProbeFitTreeProducer",
    ...
    beamSpot = cms.InputTag("offlineBeamSpot"),
    flags = cms.PSet(
        passGsfTrackIso = cms.InputTag("probeElePassGsfTrackIsoEle32WPTight"),
        passHLTsafe = cms.InputTag("probeEleHLTsafe"),
        passHcalIso = cms.InputTag("probeElePassHcalIsoEle32WPTight"),
        passL1T = cms.InputTag("probeElePassL1TEle32WPTight"),
        passL1TEt = cms.InputTag("probeElePassL1TEtEle32WPTight"),
        passPMS2 = cms.InputTag("probeElePassPMS2Ele32WPTight"),
        passPixelMatch = cms.InputTag("probeElePassPixelMatchEle32WPTight")
    ),
    ignoreExceptions = cms.bool(True),
    isMC = cms.bool(False),
    makeMCUnbiasTree = cms.bool(False),
...
process.hlt_sequence = cms.Sequence(process.probeElePassL1TEle32WPTight+process.probeElePassL1TEtEle32WPTight+process.probeElePassHcalIsoEle32WPTight+process.probeElePassPixelMatchEle32WPTight+process.probeElePassPMS2Ele32WPTight+process.probeElePassGsfTrackIsoEle32WPTight)
