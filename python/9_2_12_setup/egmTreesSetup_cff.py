...
def setTagsProbes(process, options):
    ...
    process.probeEle.inputs      = cms.InputTag("probeEleCutBasedTight80X")
    ...
    process.probeElePassHLT.filterNames  = cms.vstring("hltEle25CaloIdLMWPMS2Filter") #### the last filter of the path
    process.probeElePassHLT.isAND        = cms.bool(False)


    ### Only valid for:
    #pathName = "HLT_DoubleEle25_CaloIdL_MW_v2"
    #### seeded leg
    #SeededFilterPre = "hltEG25"
    #l1tFilt = "hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter"
    #SeededEt25Filter = SeededFilterPre + "EtFilter"
    #SeededHEFilter = SeededFilterPre + "HEFilter"
    #SeededClusterShapeFilter = SeededFilterPre + "CaloIdLClusterShapeFilter"
    #SeededPMFilter = "hltEle25CaloIdLPixelMatchFilter"

    #process.probeElePassL1T               = process.probeElePassHLT.clone()
    #process.probeElePassL1T.filterNames   = cms.vstring(l1tFilt)

    #process.probeElePassSeededEt25               = process.probeElePassHLT.clone()
    #process.probeElePassSeededEt25.filterNames   = cms.vstring(SeededEt25Filter)

    #process.probeElePassSeededHE               = process.probeElePassHLT.clone()
    #process.probeElePassSeededHE.filterNames   = cms.vstring(SeededHEFilter)

    #process.probeElePassSeededClusterShape               = process.probeElePassHLT.clone()
    #process.probeElePassSeededClusterShape.filterNames   = cms.vstring(SeededClusterShapeFilter)

    #process.probeElePassSeededPM               = process.probeElePassHLT.clone()
    #process.probeElePassSeededPM.filterNames   = cms.vstring(SeededPMFilter)
  
    #### unseeded leg 
    #UnSeededFilterPre = "hltDiEG25"
    #UnSeededHEFilter = UnSeededFilterPre + "HEUnseededFilter"
    #UnSeededClusterShapeFilter = UnSeededFilterPre + "CaloIdLClusterShapeUnseededFilter" 
    #UnSeededPMFilter = "hltDiEle25CaloIdLPixelMatchUnseededFilter"

    #process.probeElePassUnSeededHE               = process.probeElePassHLT.clone()
    #process.probeElePassUnSeededHE.filterNames   = cms.vstring(UnSeededHEFilter)

    #process.probeElePassUnSeededClusterShape               = process.probeElePassHLT.clone()
    #process.probeElePassUnSeededClusterShape.filterNames   = cms.vstring(UnSeededClusterShapeFilter)

    #process.probeElePassUnSeededPM               = process.probeElePassHLT.clone()
    #process.probeElePassUnSeededPM.filterNames   = cms.vstring(UnSeededPMFilter)
...
def setSequences(process, options):
    ...
    process.hlt_sequence = cms.Sequence( 
                                         ...
                                         #+ process.probeElePassSeededEt25
                                         #+ process.probeElePassSeededHE
                                         #+ process.probeElePassSeededClusterShape
                                         #+ process.probeElePassSeededPM
                                         #### unseeded leg
                                         #+ process.probeElePassUnSeededHE
                                         #+ process.probeElePassUnSeededClusterShape
                                         #+ process.probeElePassUnSeededPM
