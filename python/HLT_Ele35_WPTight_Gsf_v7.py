# hltGetConfiguration orcoff:/cdaq/physics/Run2017/2e34/v3.0.0/HLT/V1 --process HLTX --globaltag 94X_mc2017_realistic_v10 --path HLTriggerFirstPath,HLTriggerFinalPath,HLT_Ele35_WPTight_Gsf_v7 --offline --l1Xml L1Menu_Collisions2017_dev_r10.xml --unprescale
...
process.HLT_Ele35_WPTight_Gsf_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEGor + process.hltPreEle35WPTightGsf + process.HLTEle35WPTightGsfSequence + process.HLTEndSequence )
